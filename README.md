...
You can also directly install the CSS4J artifacts into your local Maven repository, with the similar [`install-css4j`](https://raw.githubusercontent.com/css4j/css4j-dist/master/install-css4j.sh).
