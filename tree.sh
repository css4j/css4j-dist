...
#
DIR=css4j
/usr/bin/svn export https://github.com/css4j/css4j/branches/1-stable ${DIR}
rm ${DIR}/.gitignore
rm ${DIR}/.gitattributes
cp -fp ${DIR}/LICENSES.txt .
DIR=css4j-dom4j
/usr/bin/svn export https://github.com/css4j/css4j-dom4j/branches/1-stable ${DIR}
rm ${DIR}/.gitignore
rm ${DIR}/.gitattributes
DIR=css4j-agent
/usr/bin/svn export https://github.com/css4j/css4j-agent/branches/1-stable ${DIR}
rm ${DIR}/.gitignore
rm ${DIR}/.gitattributes
cat LICENSES.txt >> ../LICENSES.txt
DIR=css4j-awt
/usr/bin/svn export https://github.com/css4j/css4j-awt/branches/1-stable ${DIR}
rm ${DIR}/.gitignore
rm ${DIR}/.gitattributes
