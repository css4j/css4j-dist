...
${SVN} export https://github.com/css4j/css4j/trunk ${DIR}
rm ${DIR}/.gitignore
rm ${DIR}/.gitattributes
cp -fp ${DIR}/LICENSES.txt .
DIR=css4j-dom4j
${SVN} export https://github.com/css4j/css4j-dom4j/trunk ${DIR}
rm ${DIR}/.gitignore
rm ${DIR}/.gitattributes
DIR=css4j-agent
${SVN} export https://github.com/css4j/css4j-agent/trunk ${DIR}
rm ${DIR}/.gitignore
rm ${DIR}/.gitattributes
cat ${DIR}/LICENSES.txt >> LICENSES.txt
DIR=css4j-awt
${SVN} export https://github.com/css4j/css4j-awt/trunk ${DIR}
rm ${DIR}/.gitignore
rm ${DIR}/.gitattributes
